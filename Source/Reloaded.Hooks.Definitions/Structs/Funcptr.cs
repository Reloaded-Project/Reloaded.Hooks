...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    public unsafe struct FuncPtr<TReturn>
    {
        ...
        /// </summary>
        public delegate*cdecl<TReturn> Invoke;

        public FuncPtr(delegate*cdecl<TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<TReturn>(FuncPtr<TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<TReturn>(delegate*cdecl<TReturn> ptr) => new FuncPtr<TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, TReturn>(FuncPtr<T1, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, TReturn>(delegate*cdecl<T1, TReturn> ptr) => new FuncPtr<T1, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, TReturn>(FuncPtr<T1, T2, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, TReturn>(delegate*cdecl<T1, T2, TReturn> ptr) => new FuncPtr<T1, T2, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, TReturn>(FuncPtr<T1, T2, T3, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, TReturn>(delegate*cdecl<T1, T2, T3, TReturn> ptr) => new FuncPtr<T1, T2, T3, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, TReturn>(FuncPtr<T1, T2, T3, T4, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, TReturn>(delegate*cdecl<T1, T2, T3, T4, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, T5, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, T5, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, T5, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, T5, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, T5, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, T5, TReturn>(FuncPtr<T1, T2, T3, T4, T5, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, T5, TReturn>(delegate*cdecl<T1, T2, T3, T4, T5, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, T5, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, T5, T6, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, T5, T6, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, T5, T6, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, T5, T6, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, T5, T6, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, T5, T6, TReturn>(FuncPtr<T1, T2, T3, T4, T5, T6, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, T5, T6, TReturn>(delegate*cdecl<T1, T2, T3, T4, T5, T6, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, T5, T6, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, T5, T6, T7, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, T5, T6, T7, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, TReturn>(FuncPtr<T1, T2, T3, T4, T5, T6, T7, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, T5, T6, T7, TReturn>(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, T5, T6, T7, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, TReturn>(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, TReturn>(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TReturn>(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TReturn>(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TReturn>(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TReturn>(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TReturn>(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TReturn>(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TReturn>(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TReturn>(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn>(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn>(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TReturn>(ptr);
    ...
    public unsafe struct FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn>
    {
        ...
        /// Calls the underlying function.
        /// </summary>
        public delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn> Invoke;

        public FuncPtr(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn> ptr) { Invoke = ptr; }
        public FuncPtr(void* ptr) { Invoke = (delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn>) ptr; }

        public static implicit operator void*(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn> func) => func.Invoke;
        public static implicit operator delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn>(FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn> func) => func.Invoke;
        ...
        public static implicit operator FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn>(delegate*cdecl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn> ptr) => new FuncPtr<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TReturn>(ptr);
